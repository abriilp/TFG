...
def parse(opt_path, is_train=True):
    ...
    opt["wandb_run"] = str(opt["wandb_run"])+"-"+str(random.randint(0,999999)) #abril
    ...
    if is_train:
        ...
        opt["path"]["experiments_root"] = experiments_root+'/'+opt["wandb_run"]
        ...
        opt["path"]["val_images"] = osp.join(opt["path"]["experiments_root"], "val_images")
